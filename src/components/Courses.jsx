...
function Courses() {
  ...
  return (
    <div className="course-wrapper">
      {loading ? (
        <>
        <div role="status" className="flex justify-center items-center gap-2 mt-24">
        <svg  aria-hidden="true" className="lg:w-24 lg:h-24 md:w-16 md:h-16 w-12 h-12 text-gray-200 animate-spin dark:text-gray-600 fill-white" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className='font-bold text-md'>Loading courses...</div> 
    </div>
